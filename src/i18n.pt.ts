...
export const PT = {
  ...
  "migration.title": "Migrar do Prometheus",
  "migration.row.ready": "{summary}. Os worktrees continuam onde estão.",
  "migration.row.imported": "Dados importados em {date}.",
  "migration.row.targetNotEmpty": "Esta importação só fica disponível antes de criar projetos ou workspaces no Prometeu.",
  "migration.row.invalid": "Não deu para preparar a importação.",
  "migration.review": "Revisar",
  "migration.preview": "O Prometeu encontrou {summary} na instalação anterior.",
  "migration.preview.history": "{found}; {missing}.",
  "migration.preview.extras": "{plugins} e {settings} entram junto com o quadro.",
  "migration.preview.worktrees": "{existing} de {total} worktrees ainda existem. Eles serão usados no lugar atual, sem cópia nem mudança de pasta.",
  "migration.preview.excluded": "Tokens do Linear e do time, cotas, caches e preferências da interface ficam de fora. O Linear precisará ser conectado novamente.",
  "migration.closed": "O Prometheus está fechado. Depois da importação, não vou abrir os mesmos workspaces nos dois aplicativos.",
  "migration.cancel": "Cancelar",
  "migration.go": "Importar",
  "migration.doing": "Importando…",
  "migration.done": "Dados importados. O backup está em {backup}",
  "migration.projects.one": "{n} projeto",
  "migration.projects.other": "{n} projetos",
  "migration.workspaces.one": "{n} workspace",
  "migration.workspaces.other": "{n} workspaces",
  "migration.tabs.one": "{n} conversa",
  "migration.tabs.other": "{n} conversas",
  "migration.histories.one": "{n} histórico disponível",
  "migration.histories.other": "{n} históricos disponíveis",
  "migration.missingHistories.one": "{n} aba sem arquivo de histórico",
  "migration.missingHistories.other": "{n} abas sem arquivo de histórico",
  "migration.plugins.one": "{n} plugin",
  "migration.plugins.other": "{n} plugins",
  "migration.settingsFiles.one": "{n} configuração de repositório",
  "migration.settingsFiles.other": "{n} configurações de repositório",
  ...
  "err.import.running": "feche o Prometheus antes de importar",
  "err.import.missing": "não encontrei uma instalação do Prometheus para importar",
  "err.import.targetNotEmpty": "o Prometeu já tem projetos ou workspaces; a importação automática não vai misturar os dois quadros",
  "err.import.board": "não consegui ler o quadro do Prometheus: {cause}",
  "err.import.plugins": "não consegui ler o cadastro de plugins: {cause}",
  "err.import.pluginName": "o cadastro antigo tem um plugin sem nome",
  "err.import.pluginConflict": "já existe outro plugin chamado {name} no Prometeu",
  "err.import.missingPath": "a importação esperava encontrar {path}",
  "err.import.conflict": "já existe outro dado em {path}; nada foi sobrescrito",
  "err.import.settings": "a configuração {path} não é um TOML válido: {cause}",
  "err.import.changed": "o quadro do Prometheus mudou durante a importação; feche o aplicativo antigo e tente de novo",
  "err.import.read": "não consegui ler {path}: {cause}",
  "err.import.write": "não consegui gravar {path}: {cause}",
