...
test("the personal catalog keeps skills private, publishes explicitly and creates independent copies", async ({ page }) => {
  ...
  await expect(pending.locator(".resource-origin")).toHaveText("This MacPersonal ⇄");
  ...
  await expect(local.locator(".resource-origin")).toHaveText("This Mac");
  ...
  await expect(local.locator(".resource-origin")).toHaveText("This MacPersonal ⇄");
  ...
  await expect(copy.locator(".resource-origin")).toHaveText("This Mac");
